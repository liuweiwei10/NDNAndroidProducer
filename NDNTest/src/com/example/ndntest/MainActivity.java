...
public class MainActivity extends Activity{
	...
	private static final String TAG = "NDNTest";
	...
	private static class Echo implements OnInterestCallback, OnRegisterFailed {
		...
		public void onInterest(Name prefix, Interest interest, Face face, long interestFilterId,
		    ...
		    String message ="Got interest with name " + interest.getName().toUri();
			...
			} catch (SecurityException | net.named_data.jndn.security.SecurityException exception) {
